  ...
  return (
    <form onSubmit={handleSubmit} className="glass-strong flex flex-col gap-4 rounded-2xl p-6">
      <div className="flex items-center gap-2 text-cyan-600">
        <Users size={18} />
        <h3 className="font-display text-base font-semibold text-navy-900">Join classroom</h3>
      </div>
      ...
      <button
        type="submit"
        className="mt-2 rounded-full border border-cyan-400/40 py-2.5 text-sm font-medium text-cyan-600 transition-colors hover:bg-cyan-400/10"
      >
        Join Classroom
      </button>
    </form>
