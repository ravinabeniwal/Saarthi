  ...
  return (
    <div className="glass-strong flex h-full flex-col gap-4 rounded-2xl p-5">
      <div className="flex items-center justify-between">
        <h3 className="font-display text-base font-semibold text-navy-900">Saarthi AI</h3>
      </div>

      <AIStatus state={state} />

      <div className="flex items-start gap-3 text-sm">
        <BookOpen size={16} className="mt-0.5 shrink-0 text-cyan-600" />
        <div>
      ...
      <div className="flex items-start gap-3 text-sm">
        <Target size={16} className="mt-0.5 shrink-0 text-cyan-600" />
        <div>
      ...
      <div className="flex items-center gap-3 text-sm">
        <Gauge size={16} className="shrink-0 text-cyan-600" />
      ...
      {suggestedResponse && (
        <div className="mt-auto flex items-start gap-3 rounded-xl border border-cyan-400/20 bg-cyan-400/5 p-3 text-sm">
          <MessageSquareText size={16} className="mt-0.5 shrink-0 text-cyan-600" />
          <div>
            <p className="text-[11px] uppercase tracking-wide text-cyan-600/70">Suggested response</p>
