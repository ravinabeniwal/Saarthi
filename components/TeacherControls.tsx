  ...
  return (
    <div className="glass-strong flex flex-wrap items-center justify-center gap-3 rounded-2xl p-3">
      <button
        ...
        className={cn(btn, micOn ? "bg-navy-900/10 text-navy-900" : "bg-rose-500/20 text-rose-600")}
      ...
      <button
        ...
        className={cn(btn, camOn ? "bg-navy-900/10 text-navy-900" : "bg-rose-500/20 text-rose-600")}
        aria-label="Toggle camera"
      >
        {camOn ? <Video size={18} /> : <VideoOff size={18} />}
      </button>

      <div className="mx-1 h-8 w-px bg-navy-900/10" />

      <button
        onClick={onMuteSaarthi}
        className={cn(btn, muted ? "bg-rose-500/20 text-rose-600" : "bg-navy-900/10 text-navy-900")}
      ...
      <button
        ...
        className={cn(btn, paused ? "bg-amber-400/20 text-amber-600" : "bg-navy-900/10 text-navy-900")}
      ...
      <button
        ...
        className={cn(btn, "bg-cyan-400/20 text-cyan-600")}
      ...
      <button
        ...
        className={cn(btn, "bg-rose-500 text-navy-900 hover:bg-rose-600")}
