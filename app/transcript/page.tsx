    ...
    <div className="flex">
      ...
      <main className="flex-1 p-6">
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h1 className="font-display text-xl font-semibold text-white">Live Transcript</h1>
            <p className="text-sm text-mist/60">Channel: {channel}</p>
          </div>
          <div className="flex gap-2 text-xs text-mist/60">
            <span className="rounded-full border border-white/10 px-3 py-1">{counts.concept} concepts</span>
            <span className="rounded-full border border-white/10 px-3 py-1">{counts.question} questions</span>
            <span className="rounded-full border border-white/10 px-3 py-1">{counts.confusion} confusion</span>
            <span className="rounded-full border border-white/10 px-3 py-1">{counts.intervention} interventions</span>
          </div>
        </div>
